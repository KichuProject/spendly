        ...
        <View style={[styles.sheet, { backgroundColor: colors.surface, borderColor: colors.border, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl }]}>
          ...
          <View style={styles.header}>
            <View style={styles.headerTitleRow}>
              <ThemedText variant="h2" color="primary">Edit Friend</ThemedText>
          ...
          <View style={styles.content}>
            <ThemedText variant="bodySmall" color="secondary" style={styles.fieldLabel}>Change your friend's name</ThemedText>
            <ThemedInput
